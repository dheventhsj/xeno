...
import { X, Sparkles, Clock, Target, ShoppingBag, Megaphone, Users, ExternalLink, Loader2 } from "lucide-react";
              ...
              <div className="glass-inner p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 text-[10px]">
                  {[
                    ...
                    ["Total Spend", `₹${Math.round(data.customer.totalSpend ?? 0).toLocaleString("en-IN")}`],
                    ["LTV", `₹${Math.round(data.scores.ltvScore).toLocaleString("en-IN")}`],
                    ["Churn", `${Math.round(data.scores.churnScore * 100)}%`],
              ...
              {data.purchaseHistory && (
                <section>
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-3 text-[10px]">
                    ...
                    <div className="glass-inner p-2"><span className="text-[#8A8A8A]">Days Since</span><div className="text-white font-mono">{data.purchaseHistory.daysSinceLastPurchase}</div></div>
                  </div>
              ...
              {data.campaignHistory?.length > 0 && (
                <section>
                  ...
                  <div className="space-y-2">
                    {data.campaignHistory.map((c: any, i: number) => (
